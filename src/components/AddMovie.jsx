  ...
  render() {
    ...
    return (
      <form className="addMovie" data-testid="add-movie-form">
        <title htmlFor="title-input" data-testid="title-input-label">
          Título:
          {this.AddInput('title', 'text', title, this.handleChange)}
        </title>
        <subtitle htmlFor="subtitle-input" data-testid="subtitle-input-label">
          Subtítulo:
          {this.AddInput('subtitle', 'text', subtitle, this.handleChange)}
        </subtitle>
        <image htmlFor="image-input" data-testid="image-input-label">
          Imagem:
        ...
        <rate htmlFor="rating-input" data-testid="rating-input-label">
          Avaliação:
          {this.AddInput('rating', 'number', rating, this.handleChange)}
        </rate>
        <genre htmlFor="genre-input" data-testid="genre-input-label">
          Gênero:
          <select
            name="genre"
            value={ genre }
