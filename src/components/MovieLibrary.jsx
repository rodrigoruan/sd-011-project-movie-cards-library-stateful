...
class MovieLibrary extends React.Component {
  ...
  addingNewMovie(title, subtitle, storyline, imagePath, rating, genre) {
    const newMovie = {title, subtitle, storyline, imagePath, rating: Number(rating), genre, bookmarked: false};
