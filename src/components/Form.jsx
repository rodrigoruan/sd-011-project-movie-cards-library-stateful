   ...
   render() {
    ...
    return (
      <form data-testid="add-movie-form">
        ...
        <input
          type="text" name="title" data-testid="title-input" value={title} onChange={func}
        />
        </label>
        
        <label data-testid="subtitle-input-label" htmlFor="subtitle-input"> "Subtítulo"
          <input
          type='text' name="subtitle" data-testid="subtitle-input" value={subtitle} onChange={func}
          />
        </label>

        <label data-testid="image-input-label"> "Imagem"
          <input
          type='text' name="imagePath" data-testid="image-input" value={imagePath} onChange={func}
          />
        </label>
