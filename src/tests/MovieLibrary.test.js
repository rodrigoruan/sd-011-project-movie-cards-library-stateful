...
describe('18 - Renderize `<MovieList />` dentro de `<MovieLibrary />`', () => {
  ...
  it.only('Filtre os filmes por título de acordo com o que for digitado na barra de busca', () => {
  ...
  it.only('Filtre os filmes por subtítulo de acordo com o que for digitado na barra de busca', () => {
    const { getByTestId, getAllByTestId } = render(<MovieLibrary movies={ movies } />);
    const textInput = getByTestId(textTestId);
  ...
  it.only('Filtre os filmes por sinopse de acordo com o que for digitado na barra de busca', () => {
    const { getByTestId, getAllByTestId } = render(<MovieLibrary movies={ movies } />);
    const textInput = getByTestId(textTestId);
  ...
  it.only('Renderize a lista de filmes sem filtragens se a barra de buscar estiver vazia', () => {
  ...
  it.only('Filtre os filmes por favoritos quando a `checkbox` relacionada for selecionada', () => {
    const { getByTestId, getAllByTestId } = render(<MovieLibrary movies={ movies } />);
    const bookmarkedOnly = getByTestId(checkboxTestId);
  ...
  it.only('Filtre os filmes por categoria quando a `checkbox` relacionada for selecionada', () => {
    const { getByTestId, getAllByTestId } = render(<MovieLibrary movies={ movies } />);
...
describe('19 - Renderize `<AddMovie />` dentro de `<MovieLibrary />`', () => {
  ...
  it.only('Adicione, após preenchimento do formulário e clique no botão de enviar, o novo filme à lista de filmes', () => {
    const { getByTestId, getAllByTestId } = render(<MovieLibrary movies={ movies } />);
